...
from pgvector.sqlalchemy import Vector  # Import loads `vector` type handler into SQLAlchemy
...
def register_vector_async_on_connect(dbapi_connection, connection_record):  # noqa: ARG001. Argument needed for compatibility
    dbapi_connection.run_async(register_vector_async)


@event.listens_for(sync_engine, "connect")
def register_vector_on_connect(dbapi_connection, connection_record):  # noqa: ARG001. Argument needed for compatibility
